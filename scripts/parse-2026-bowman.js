...
const SECTIONS = [
  ...
  ['PAPER PROSPECTS',                            'Paper Prospects', 'Prospects'],
  ['CHROME NFL BASE',                            'Chrome', 'Base'],
  ['CHROME ROOKIE BASE',                         'Chrome Rookies', 'Base'],
  ['CHROME PROSPECTS',                           'Chrome Prospects', 'Prospects'],
  ['1955 ALL AMERICAN AUTOGRAPH VARIATION',      '1955 All American Autograph Variation', 'Autographs'],
  ...
  ['BASE CHROME AUTOGRAPHS',                     'Chrome Autographs', 'Autographs'],
  ['BASE PAPER NFL AUTOGRAPHS',                  'Paper NFL Autographs', 'Autographs'],
  ['BASE CHROME ROOKIE AUTOGRAPHS',              'Chrome Rookie Autographs', 'Autographs'],
  ['BASE PAPER ROOKIE AUTOGRAPHS',               'Paper Rookie Autographs', 'Autographs'],
  ['CHROME PROSPECT AUTOGRAPHS',                 'Chrome Prospect Autographs', 'Autographs'],
  ['PAPER PROSPECT AUTOGRAPHS',                  'Paper Prospect Autographs', 'Autographs'],
  ['BOWMAN DUAL CROSS SPORT AUTOGRAPHS',         'Dual Cross Sport Autographs', 'Autographs'],
  ['BOWMAN DUAL NFL AUTOGRAPHS',                 'Dual NFL Autographs', 'Autographs'],
  ['BOWMAN DUAL NIL AUTOGRAPHS',                 'Dual NIL Autographs', 'Autographs'],
  ['BOWMAN TRIPLE NFL AUTOGRAPHS',               'Triple NFL Autographs', 'Autographs'],
  ['BOWMAN TRIPLE NIL AUTOGRAPHS',               'Triple NIL Autographs', 'Autographs'],
  ['BUZZ FACTOR AUTOGRAPHS',                     'Buzz Factor Autographs', 'Autographs'],
  ['FUTURE SCRIPT',                              'Future Script', 'Autographs'],
  ['OPENING STATEMENT SIGNATURES',               'Opening Statement Signatures', 'Autographs'],
  ['TIMELESS TOUCH SIGNATURES',                  'Timeless Touch Signatures', 'Autographs'],
];
